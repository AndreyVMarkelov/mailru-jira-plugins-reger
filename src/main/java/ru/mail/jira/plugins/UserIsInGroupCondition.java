...
/**
 * Check visibility "web-item" for group "employees of department of game division".
 * 
 * @author Andrey Markelov
 */
@SuppressWarnings("deprecation")
public class UserIsInGroupCondition
    extends AbstractJiraCondition
{
     ...
     * Constructor.
     */
    public UserIsInGroupCondition(ConfigurationManager configurationManager)
    {
